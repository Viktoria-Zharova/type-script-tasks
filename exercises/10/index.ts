...
export function promisify<T>(callback: (response: ApiResponse<T>) => void): () => Promise<T> {
...
export function promisifyAll(obj: Record<string, (...args: any[]) => void>): Record<string, () => Promise<any>> {
    const promisifiedObj: Record<string, () => Promise<any>> = {};
